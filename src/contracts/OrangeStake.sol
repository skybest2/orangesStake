...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Orange Token";
    string internal constant SYMBOL = "ORANGE";
    ...
    address internal charityAddress = 0xB06762533BC59D7f926B34113404865429Db5025;
    address internal stakingRewards = 0xffac27092f1236B27D49133bC73317EC72903626;
    ...
    function _addFees() private {
        _addFee(FeeType.Liquidity, 30, address(this) );//30%
        _addFee(FeeType.External, 100, charityAddress );//10$
        _addFee(FeeType.External, 50, stakingRewards );//5%
    }
...
contract orangeStake is BaseRfiToken, Liquifier, Antiwhale {
...
contract ORANGESTAKE is orangeStake{

    constructor() orangeStake(Env.Testnet){
